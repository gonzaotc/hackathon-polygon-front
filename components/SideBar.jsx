			...
			<div className="flex min-w-[14rem]">
				<div className="fixed flex h-[calc(100vh-3rem-150px-1.5rem)] flex-col justify-between 2xl:h-[calc(100vh-4rem-150px-1.5rem)]">
					...
					<div className="flex flex-col items-start text-white">
						<div className="flex w-full flex-col items-start justify-center gap-1.5 border-white text-sm text-white/80  2xl:text-lg">
							<button className="flex flex-row items-center gap-1.5 hover:text-white">
								<Image
									width={20}
									height={20}
									alt="telegram icon"
							...
							<button
								...
								className="flex flex-row items-center gap-1.5 hover:text-white"
							>
								<Image
									width={20}
									height={20}
